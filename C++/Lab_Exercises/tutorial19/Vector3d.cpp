...
Vector3d &Vector3d::Add7(const Vector3d& L, const Vector3d& R) 
{
	...
	*this = Vector3d (L.x+R.x, L.y+R.y, L.z+R.z);	
	return *this;
}
...
Vector3d Vector3d::Assign(double X, double Y, double Z)
{
	Vector3d v(X,Y,Z);
	return v;
}
...
//-----------------------------------------------------------------------------
Vector3d Vector3d::Copy(const Vector3d V)
{
