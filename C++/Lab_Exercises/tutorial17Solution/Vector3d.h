...
public:
	...
	*/
	...
	/**
	* Calculate the Cross Product (Vector Product) between the vector in place
	* and another vector
	*/
	...
	*/
	...
	/**
	* Multiply vector in place by n
	*/
	Vector3d Multiply(double n) const;
	...
	*/
	double operator * (const Vector3d &V) const { return DotProduct(V); }
	...
	* Multiply vector in place by n
	*/
	Vector3d operator * (double n) const { return Multiply(n); }
