...
public:
	...
	void drawImmediateQuads(void);
	void drawArraysUsingSeparateVertexArrays(void);
	void drawArraysUsingSeparateVertexArraysQuads(void);
	void drawArraysUsingInterleavedVertexArrays(void);
	void drawElementsUsingInterleavedVertexArrays(void);
	void drawElementsUsingInterleavedVertexArraysQuads(void);
	void drawRangeElementsUsingSeparateVertexArrays(void);
	void drawDisplayList(void);

	void fillDisplayList(void);
	void fillCubeInterleavedVertexArray(void);
	void fillCubeInterleavedVertexArrayElements(void);
	void fillCubeInterleavedVertexArrayQuads(void);
	void fillCubeSeparateVertexArrays(void);
	void fillCubeVerticesObject(void);
	void fillCubeIndicesObject(void);
	void fillDrawRangeIndices(void);
	void fillDrawRangeIndicesQuads(void);
	void fillDrawRangeVertices(void);
	void buildVBOs(void);
};
